...
export default function MandiGobindgarhPage() {
  const schema = {"@context":"https://schema.org","@type":"Service","name":"Induction Heat Treatment — Mandi Gobindgarh","provider":{"@type":"LocalBusiness","name":SITE_NAME,"telephone":SITE_PHONE_NUMBER},"areaServed":["Mandi Gobindgarh","Ludhiana","Khanna","Fatehgarh Sahib"]};

  return (
    <>
      <JsonLd data={schema} />
      <BreadcrumbJsonLd items={[{ name: 'Heat Treatment', href: '/induction-heat-treatment' }, { name: 'Mandi Gobindgarh', href: '/induction-heat-treatment/mandi-gobindgarh' }]} />
      <div className="bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <PageHeader
            title="Induction Heat Treatment Services"
            highlightedWord="Mandi Gobindgarh"
            description="Specialized induction hardening & tempering for Mandi Gobindgarh’s toolrooms, foundries & steel manufacturers."
          ...
          >
            <p className="text-xl text-muted-foreground font-medium leading-relaxed">
              Serving Mandi Gobindgarh’s heavy industry with induction hardening, tempering and stress relief. We provide batch processing, traceable test reports and mobile on-site services for large shafts and rolls.
            </p>
          </motion.section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 py-20 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground">
                  Located near the steel capital of India, we specialize in high-capacity treatment for Mandi Gobindgarh's rolling mills and tool rooms.
                </p>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-6">Mandi Gobindgarh Support</h3>
              <p className="text-muted-foreground mb-8 font-medium">
                Offering industrial-grade surface hardening for large diameters and heavy-duty mechanical parts.
              </p>
          ...
          <section className="py-24 border-t border-border">
            <h2 className="text-2xl md:text-4xl font-black uppercase italic tracking-tighter mb-12 text-center">
              Related <span className="text-primary">Hardening</span>
            </h2>
