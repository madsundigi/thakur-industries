...
export default function KhannaPage() {
  const schema = {"@context":"https://schema.org","@type":"Service","name":"Induction Heat Treatment — Khanna","provider":{"@type":"LocalBusiness","name":SITE_NAME,"telephone":SITE_PHONE_NUMBER},"areaServed":["Khanna","Ludhiana","Samrala","Phillaur"]};
      ...
      <div className="bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <PageHeader
            ...
            description="Precision induction hardening for Khanna industries — shafts, gears, rolls. Workshop & mobile services with hardness testing."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 py-20 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground">
                  As Khanna is a major industrial node, we support its rolling mills and machinery units with deep-case hardening.
                </p>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-6">Khanna Logistics</h3>
              <p className="text-muted-foreground mb-8 font-medium">
                Timely pickup and delivery for job work across Khanna, Samrala, and Phillaur. High-capacity induction for large industrial rolls.
              </p>
              <div className="flex items-center gap-3 text-primary font-black uppercase tracking-widest text-sm mb-8">
                <MapPin className="h-5 w-5" /> Area: Khanna, Samrala, Phillaur
              </div>
              <Button asChild className="w-full py-8 text-lg font-black uppercase italic">
                <Link href="/contact">Contact Khanna Team</Link>
              </Button>
            </motion.div>
          </div>
          ...
          <section className="py-24 border-t border-border">
            <h2 className="text-2xl md:text-4xl font-black uppercase italic tracking-tighter mb-12 text-center">
              Related <span className="text-primary">Nodes</span>
            </h2>
              ...
              {[
                ...
                <Link key={i} href={link.href} className="group">
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground mt-2">View Process Tech</p>
                  </motion.div>
                </Link>
              ))}
            </div>
