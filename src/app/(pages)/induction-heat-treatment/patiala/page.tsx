...
export default function PatialaPage() {
  const schema = {"@context":"https://schema.org","@type":"Service","name":"Induction Heat Treatment — Patiala","provider":{"@type":"LocalBusiness","name":SITE_NAME,"telephone":SITE_PHONE_NUMBER},"areaServed":["Patiala","Ludhiana","Ambala","Chandigarh"]};
      ...
      <div className="bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <PageHeader
            ...
            description="Precision induction heat treatment in Patiala — gears, shafts, bearings. Workshop & mobile induction hardening with testing."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 py-20 items-center">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter mb-8 leading-none">
                Regional <span className="text-primary">Coverage</span>
              </h2>
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground">
                  Our Patiala focus serves the southern Punjab belt, extending professional hardening services to Ambala and Chandigarh industrial zones.
                </p>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-6">Patiala Industry Support</h3>
              <p className="text-muted-foreground mb-8 font-medium">
                Offering technical excellence for Patiala's automotive and engine component manufacturers. Traceable reports for every batch.
              </p>
              <div className="flex items-center gap-3 text-primary font-black uppercase tracking-widest text-sm mb-8">
                <MapPin className="h-5 w-5" /> Area: Patiala, Rajpura, Ambala
              </div>
              <Button asChild className="w-full py-8 text-lg font-black uppercase italic">
                <Link href="/contact">Request Patiala Quote</Link>
              </Button>
            </motion.div>
          </div>
