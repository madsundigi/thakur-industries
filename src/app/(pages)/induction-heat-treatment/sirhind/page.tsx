...
export default function SirhindPage() {
  const schema = {"@context":"https://schema.org","@type":"Service","name":"Induction Heat Treatment — Sirhind","provider":{"@type":"LocalBusiness","name":SITE_NAME,"telephone":SITE_PHONE_NUMBER},"areaServed":["Sirhind","Fatehgarh Sahib","Ludhiana","Rajpura"]};
      ...
      <div className="bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <PageHeader
            ...
            description="Induction hardening & tempering in Sirhind for automotive and tooling parts. On-site and workshop services available."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 py-20 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground">
                  Our Sirhind service node provides Fatehgarh Sahib and Rajpura industrial areas with precise metallurgical hardening and tempering.
                </p>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-6">Sirhind Node</h3>
              <p className="text-muted-foreground mb-8 font-medium">
                Helping the local engineering belt achieve superior fatigue strength and hardness profiles for critical mechanical assemblies.
              </p>
              <div className="flex items-center gap-3 text-primary font-black uppercase tracking-widest text-sm mb-8">
                <MapPin className="h-5 w-5" /> Area: Sirhind, Fatehgarh Sahib
              </div>
              <Button asChild className="w-full py-8 text-lg font-black uppercase italic">
                <Link href="/contact">Request Sirhind Quote</Link>
              </Button>
            </motion.div>
          </div>
