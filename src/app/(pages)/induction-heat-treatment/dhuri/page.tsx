...
export default function DhuriPage() {
  const schema = {"@context":"https://schema.org","@type":"Service","name":"Induction Heat Treatment — Dhuri","provider":{"@type":"LocalBusiness","name":SITE_NAME,"telephone":SITE_PHONE_NUMBER},"areaServed":["Dhuri","Sangrur","Malerkotla","Ludhiana"]};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 py-20 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground">
                  Our Dhuri focus serves the industrial nodes along the Ludhiana-Sangrur highway, ensuring rapid technical support.
                </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-8 font-medium">
                Helping local engineering units achieve export-grade surface hardness and documented quality assurance.
              </p>
              <div className="flex items-center gap-3 text-primary font-black uppercase tracking-widest text-sm mb-8">
                <MapPin className="h-5 w-5" /> Area: Dhuri, Sangrur, Malerkotla
              </div>
