        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <section className="py-16 border-t border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: "Bearing Ring Assessment", description: "We evaluate bearing dimensions, bore/OD tolerances, ring material, and the required raceway case depth (typically 1–2mm)." },
                { title: "Raceway Induction Hardening", description: "Precision induction coils heat the raceway surfaces uniformly to 60–64 HRC with minimal heat input to surrounding material." },
                { title: "Roundness & Hardness Testing", description: "CMM roundness measurement, Rockwell hardness verification at multiple points, and dispatch within 2–3 working days." }
              ].map((step, i) => (
