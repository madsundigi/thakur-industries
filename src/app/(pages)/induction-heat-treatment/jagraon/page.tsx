...
export default function JagraonPage() {
  const schema = {
    ...
    "@type":"Service", 
    "name":"Induction Heat Treatment — Jagraon", 
    "provider":{"@type":"LocalBusiness","name":SITE_NAME,"telephone":SITE_PHONE_NUMBER}, 
    "areaServed":["Jagraon","Ludhiana","Moga","Jalandhar"]
  };

  return (
    <>
      <JsonLd data={schema} />
      <BreadcrumbJsonLd items={[{ name: 'Heat Treatment', href: '/induction-heat-treatment' }, { name: 'Jagraon', href: '/induction-heat-treatment/jagraon' }]} />
      <div className="bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <PageHeader
            title="Induction Heat Treatment Services"
            highlightedWord="Jagraon"
            description="Precision induction hardening for Jagraon’s manufacturing and agricultural component makers. On-site and workshop capabilities."
          ...
          >
            <p className="text-xl text-muted-foreground font-medium leading-relaxed">
              Precision induction hardening for Jagraon’s manufacturing and agricultural component makers. We handle small batches to production runs — onsite mobile units for larger parts. Hardness testing and certification provided.
            </p>
          </motion.section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 py-20 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground">
                  Our Jagraon service coverage extends to Moga and Jalandhar, providing the agricultural belt with high-durability shafts and gears.
                </p>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-6">Jagraon Support</h3>
              <p className="text-muted-foreground mb-8 font-medium">
                Supporting the agricultural heart of Punjab with hardened tiller blades, rotavator shafts, and tractor components.
              </p>
              <div className="flex items-center gap-3 text-primary font-black uppercase tracking-widest text-sm mb-8">
                <MapPin className="h-5 w-5" /> Area: Jagraon, Moga, Ludhiana
              </div>
              <Button asChild className="w-full py-8 text-lg font-black uppercase italic">
                <Link href="/contact">Book Jagraon Job Work</Link>
              </Button>
            </motion.div>
          </div>
          ...
          <section className="py-24 border-t border-border">
            <h2 className="text-2xl md:text-4xl font-black uppercase italic tracking-tighter mb-12 text-center">
              Explore <span className="text-primary">Capabilities</span>
            </h2>
              ...
              {[
                ...
                <Link key={i} href={link.href} className="group">
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground mt-2">View Technical Specs</p>
                  </motion.div>
                </Link>
              ))}
            </div>
