...
export default function SamralaPage() {
  const schema = {"@context":"https://schema.org","@type":"Service","name":"Induction Heat Treatment — Samrala","provider":{"@type":"LocalBusiness","name":SITE_NAME,"telephone":SITE_PHONE_NUMBER},"areaServed":["Samrala","Ludhiana","Khanna","Rampura Phul"]};

  return (
    <>
      <JsonLd data={schema} />
      <BreadcrumbJsonLd items={[{ name: 'Heat Treatment', href: '/induction-heat-treatment' }, { name: 'Samrala', href: '/induction-heat-treatment/samrala' }]} />
      <div className="bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <PageHeader
            title="Induction Heat Treatment Services"
            highlightedWord="Samrala"
            description="On-site & workshop induction heat treatment in Samrala. Surface hardening, case depths to spec, Rockwell testing."
          ...
          >
            <p className="text-xl text-muted-foreground font-medium leading-relaxed">
              Serving Samrala with precision induction hardening for shafts, gears, bearings and more. We offer quick turnarounds, test reports and mobile units for plant shutdowns. Upload a drawing for a technical quote.
            </p>
          </motion.section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 py-20 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-lg text-muted-foreground">
                  Our Samrala focus provides nearby industrial clusters like Khanna and Rampura Phul with reliable metallurgical support.
                </p>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-6">Local Logistics</h3>
              <p className="text-muted-foreground mb-8 font-medium">
                We handle both bulk OEM production and specialized single-piece job work for Samrala's engineering units.
              </p>
              <div className="flex items-center gap-3 text-primary font-black uppercase tracking-widest text-sm mb-8">
                <MapPin className="h-5 w-5" /> Area: Samrala, Khanna, Ludhiana
              </div>
              <Button asChild className="w-full py-8 text-lg font-black uppercase italic">
                <Link href="/contact">Inquire for Samrala</Link>
              </Button>
            </motion.div>
          </div>
          ...
          <section className="py-24 border-t border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { title: "Process Guide", href: "/induction-heat-treatment", icon: Cpu }
              ].map((link, i) => (
