...
// (WhatsApp clicks are tracked globally by ConversionTracker in the layout.)
...
export function WhatsAppButton() {
  return (
    <Link
      ...
      className={[
        'group fixed z-50 flex items-center gap-2.5 rounded-full',
        // Kept on the LEFT so it never collides with the Tawk.to chat widget (bottom-right).
        // Raised on mobile (bottom-24) to clear the full-width mobile sticky CTA bar; bottom-6 on desktop.
        'bottom-24 left-4 md:bottom-6 md:left-6',
        'bg-[#25D366] text-white hover:bg-[#1ebe5d]',
        'px-3.5 py-3 md:px-4',
        'shadow-lg shadow-[#25D366]/40 ring-1 ring-black/5',
    ...
    >
      ...
      <span className="text-sm font-bold tracking-wide whitespace-nowrap pr-0.5">
        Chat on WhatsApp
      </span>
    </Link>
  );
